...
public class Races implements IRaces{
    ...
    */
    public Races(){
        ...
        this.races = new Race[Constants.N_OF_RACES];
        
        this.horseJockeySelected = new LinkedList<>();
        
        for(int i=0; i<Constants.N_OF_RACES; i++){
    ...
    */
    ...
    public synchronized void setHorseJockeyStepSize(int id, int stepSize){
        ...
        if(this.horseJockeyStepSize.size()==Constants.N_OF_HORSES){
    ...
    */
    ...
    public boolean hasMoreRaces(){
        return !this.races[Constants.N_OF_RACES-1].horsesFinished();
    }
    ...
    */
    ...
    public boolean getAnnouncedNextRace(int raceNumber){        
        if(raceNumber>=Constants.N_OF_RACES){
            return false;
        }
    ...
    */
    ...
    public void signalShutdown() throws RemoteException {
        ...
        try {
            ...
            Logger.getLogger(Races.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            Logger.getLogger(Races.class.getName()).log(Level.SEVERE, null, e);
        ...
        try {
            ...
            System.out.println("Races registration exception: " + e.getMessage());
            Logger.getLogger(Races.class.getName()).log(Level.SEVERE, null, e);
        } catch (NotBoundException e) {
            System.out.println("Races not bound exception: " + e.getMessage());
            Logger.getLogger(Races.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        System.out.println("Races closed.");
    }
}
