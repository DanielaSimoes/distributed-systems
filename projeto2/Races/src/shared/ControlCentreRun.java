...
public class ControlCentreRun {
    ...
    public static void main(String[] args) throws SocketException {
        ...
        SERVER_PORT = nodeSettsStub.SERVER_PORTS().get("ControlCentre");
        ...
        ControlCentreInterface controlCentreInterface = new ControlCentreInterface(racesStub);
        ...
        while (true) {
            ...
            try {
                ...
                aps = new APS(schan, schani, controlCentreInterface, "ControlCentre");
                aps.start();
